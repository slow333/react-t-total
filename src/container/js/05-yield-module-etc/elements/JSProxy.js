...
function JSProxy() {
  return (
    <div>
      <div className="for-space" id='js-proxy'></div>
      <h1>Proxy</h1>
      ...
      <h5>get 트랩으로 프로퍼티 기본값 설정</h5>
      <h5>set 트랩으로 프로퍼티 값 검증</h5>
      <h5>ownKeys와 getOwnPropertyDescriptor로 반복 작업</h5>
      <h5>deleteProperty와 여러 트랩을 사용해 프로퍼티 보호</h5>
      <h5>has 트랩으로 ‘범위’ 내 여부 확인하기</h5>
      <h5>apply 트랩으로 함수 감싸기</h5>
      <h5>Reflect</h5>
      <h5>Reflect is a built-in object that simplifies creation of Proxy.</h5>
