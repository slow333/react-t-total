...
function JSAsyncGenerator() {
  ...
  return (
    <div>
      <div className="for-space" id='js-async-generator'></div>
      <h1>비동기 제너레이터</h1>
      ...
      <h3>async generator 함수</h3>
      <h4>지금 상태에서 제너레이터에 비동기 동작을 추가하려면, Symbol.iterator를
        async Symbol.asyncIterator로 바꿔야 합니다.</h4>
    <pre>{`let range = {
  from: 1,
  to: 5,
...
export default JSAsyncGenerator
