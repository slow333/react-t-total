...
function JSObjectPrototype() {
  return (
    <div>
      <div className="for-space" id='js-object-prototype'></div>
      <h1>JS Object </h1>
  ...
  let person1 = new Person("Linking", "Park", 43, ["music", "rock"]);`}</code>
    ...
    <p>생성된 객체의 prototype에 접근하기 위해서는 Object.__proto__ 로 접근해야함</p>
...
export default JSObjectPrototype
