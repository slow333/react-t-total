...
/*     field.style.position = 'relative';
  ...
  return (
    <div>
      <div className="for-space" id='dom-drag-drop'></div>
      <h1>드래그 앤 드롭과 마우스 이벤트</h1>
      <h5>어려움... 나중에 할 때...</h5>
      <h5>Pointer events: 마우스, 펜, 스타일러스 같이 터치스크린에서 input을 다루는 방법, 이것도 나중에</h5>
      ...
      <h3>document.elementFromPoint(clientX, clientY)</h3>
      <h4>주어진 윈도우 기준 좌표에서 가장 많이 중첩된 요소를 반환합니다. (윈도우 밖의 좌표는 null)</h4>
      <h4>이를 적용해야 요소가 겹처졌을 때 제대로 요소를 클릭할 수있다.</h4>
<pre>{`
field.style.position = 'relative';
let currentDroppable = null;
ball.onmousedown = function(event) {
...
export default DragDropMouseEvent
