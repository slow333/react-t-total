 ...
 */
  ...
  return (
    <div>
      <div className="for-space" id='dom-scroll-event'></div>
      <h1>window scroll</h1>

      <h2>스크롤해서 이미지 위치에 가면 이미지 보이기...</h2>
    ...
    <figure>
      <img src={placeholder} alt="solar system" data-src="https://en.js.cx/clipart/solar/planets.jpg" width="400" height="200"/>
    </figure>
    ...
    <figure>
      <img src={placeholder} alt="solar system" data-src="https://en.js.cx/clipart/solar/sun.jpg" width="400" height="200"/>
    </figure>
    ...
    <figure>
      <img src={placeholder} alt="solar system" data-src="https://en.js.cx/clipart/solar/mercury.jpg" width="390" height="200"/>
    </figure>
    ...
    <figure>
      <img src={placeholder} alt="solar system" data-src="https://en.js.cx/clipart/solar/venus.jpg" width="390" height="200"/>
    </figure>
    ...
    <figure>
      <img src={placeholder} alt="solar system" data-src="https://en.js.cx/clipart/solar/earth.jpg" width="390" height="200"/>
    </figure>
    ...
    <figure>
      <img src={placeholder} alt="solar system" data-src="https://en.js.cx/clipart/solar/mars.jpg" width="390" height="200"/>
    </figure>
    ...
    <figure>
      <img src={placeholder} alt="solar system" data-src="https://en.js.cx/clipart/solar/jupiter.jpg" width="390" height="200"/>
    </figure>
    ...
    <figure>
      <img src={placeholder} alt="solar system" data-src="https://en.js.cx/clipart/solar/saturn.jpg" width="400" height="200"/>
    </figure>
    ...
    <figure>
      <img src={placeholder} alt="solar system" data-src="https://en.js.cx/clipart/solar/uranus.jpg" width="390" height="200"/>
    </figure>
    ...
    <figure>
      <img src={placeholder} alt="solar system" data-src="https://en.js.cx/clipart/solar/neptune.jpg" width="390" height="200"/>
    </figure>
