import {eventBubbling} from '../../../../assets'
...
/*   grid.onclick = function(event) {
  ...
  return (
    <div>
      <div className="for-space" id='dom-event-bubbling'></div>
      <h1>버블링</h1>
      <img src={eventBubbling} alt="event bubbling" width="600"/>
      <h5>한 요소에 이벤트가 발생하면, 이 요소에 할당된 핸들러가 동작하고, 이어서 부모 요소의 핸들러가 동작합니다.
        가장 최상단의 조상 요소를 만날 때까지 이 과정이 반복되면서 요소 각각에 할당된 핸들러가 동작합니다.</h5>
      
      <h2>이벤트 위임;event delegation</h2>

      <h3>팔괘도 클릭한 TD 강조하기</h3>
    <pre>{`let selectedTd;
...
function highlight(td) {
  ...
  selectedTd.classList.add('highlight'); // 새로운 td를 강조 함
      ...
      <div id="menutest">
        <button data-action="save" className="action-save">저장하기</button>
        <button data-action="load" className="action-load">불러오기</button>
        <button data-action="search" className="action-search">검색하기</button>
      </div>
...
new Menu(menutest)`}</pre>
    ...
    <div id="container" className="flex flex-col">
      <div className="pane">
        <h4 className='m-0'>Horse</h4>
        <p>The horse is one of two extant subspeci. The horse l of today.</p>
        <button className="remove-button m-0">[x]</button>
      </div>
      <div className="pane">
        <h4 className='m-0'>Donkey</h4>
        <p>The donkey or asst least 5000 years.</p>
        <button className="remove-button m-0">[x]</button>
      </div>
      <div className="pane">
        <h4 className='m-0'>Cat</h4>
  ...
  event.target.closest('.pane').remove();
    ...
    <ul class="tree" id="tree">
      <li>Animals
        <ul>
          <li>Mammals
            <ul> <li>Cows</li> <li>Donkeys</li> <li>Dogs</li> <li>Tigers</li> </ul>
          </li>
          <li>Other
            <ul> <li>Snakes</li> <li>Birds</li> <li>Lizards</li>  </ul>
          </li>
        </ul>
      </li>
      <li>Fishes
        <ul>
          <li>Aquarium
            <ul> <li>Guppy</li> <li>Angelfish</li> </ul>
          </li>
          <li>Sea
...
<pre>{`tree.onclick = function(event) {
  ...
  ul.hidden = !ul.hidden;
    ...
    <table id="grid">
      ...
      <tbody>
      <tr> <td>5</td>   <td>일리야</td> </tr>
      <tr> <td>2</td>   <td>보라</td> </tr>
      <tr> <td>12</td>  <td>호진</td> </tr>
      <tr> <td>9</td>        <td>민지</td> </tr>
      <tr> <td>1</td>        <td>호석</td> </tr>
      </tbody>
    </table>
  ...
  tbody.append(...rowArray);
    ...
    <fieldset id="contents">
      ...
      <p>
        How about to read <a href="https://wikipedia.org" className='text-blue-900'>Wikipedia</a> or visit <a href="https://w3.org"><i>W3.org</i></a> and learn about modern standards?
      </p>
    </fieldset>
<pre>{`let contents = document.getElementById('contents');
  contents.onClick = function(e) {
    ...
    <ul id="thumbs" className='flex list-none'>
      ...
      <li>
        <a href="https://en.js.cx/gallery/img2-lg.jpg" title="Image 2">
          <img src="https://en.js.cx/gallery/img2-thumb.jpg" alt='img'/></a>
      </li>
      <li>
        <a href="https://en.js.cx/gallery/img3-lg.jpg" title="Image 3">
          <img src="https://en.js.cx/gallery/img3-thumb.jpg" alt='img'/></a>
      </li>
      <li>
        <a href="https://en.js.cx/gallery/img4-lg.jpg" title="Image 4">
          <img src="https://en.js.cx/gallery/img4-thumb.jpg" alt='img'/></a>
      </li>
      <li>
        <a href="https://en.js.cx/gallery/img5-lg.jpg" title="Image 5">
          <img src="https://en.js.cx/gallery/img5-thumb.jpg" alt='img'/></a>
      </li>
      <li>
        <a href="https://en.js.cx/gallery/img6-lg.jpg" title="Image 6">
          <img src="https://en.js.cx/gallery/img6-thumb.jpg" alt='img'/></a>
      </li>
    </ul>
